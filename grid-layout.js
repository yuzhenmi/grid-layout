...
GridLayout.prototype.generate3DLayout = function() {
	...
	for (n = 0; n < nodes.length; n++) {
		nodes[n].position.x = (nodes[n].position.x - gridSize * 0.5) * 20;
		nodes[n].position.y = (nodes[n].position.y - gridSize * 0.5) * 20;
		nodes[n].position.z = (nodes[n].position.z - gridSize * 0.5) * 20;
	}
